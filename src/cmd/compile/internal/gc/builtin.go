...
const runtimeimport = "" +
	...
	"func @\"\".makemap (@\"\".mapType·2 *byte, @\"\".hint·3 int64, @\"\".mapbuf·4 *any, @\"\".bucketbuf·5 *any, @\"\".concurrencyLevel·6 int64) (@\"\".hmap·1 map[any]any)\n" +
	...
	"func @\"\".maprelease ()\n" +
	"func @\"\".mapacquire (@\"\".mapType·2 *byte, @\"\".hmap·3 map[any]any, @\"\".key·4 *any) (? *any)\n" +
	"func @\"\".cmapiterinit (@\"\".mapType·1 *byte, @\"\".hmap·2 map[any]any, @\"\".hiter·3 *any)\n" +
	"func @\"\".cmapiterinit_interlocked (@\"\".mapType·1 *byte, @\"\".hmap·2 map[any]any, @\"\".hiter·3 *any)\n" +
	"func @\"\".cmapiternext (@\"\".hiter·1 *any)\n" +
	"func @\"\".cmapiternext_interlocked (@\"\".hiter·1 *any)\n" +
	"func @\"\".cmapaccess1_interlocked (@\"\".mapType·2 *byte, @\"\".info·3 *any, @\"\".hmap·4 map[any]any, @\"\".key·5 *any) (@\"\".val·1 *any)\n" +
	"func @\"\".cmapaccess1_fast32_interlocked (@\"\".mapType·2 *byte, @\"\".info·3 *any, @\"\".hmap·4 map[any]any, @\"\".key·5 any) (@\"\".val·1 *any)\n" +
	"func @\"\".cmapaccess1_fast64_interlocked (@\"\".mapType·2 *byte, @\"\".info·3 *any, @\"\".hmap·4 map[any]any, @\"\".key·5 any) (@\"\".val·1 *any)\n" +
	"func @\"\".cmapaccess1_faststr_interlocked (@\"\".mapType·2 *byte, @\"\".info·3 *any, @\"\".hmap·4 map[any]any, @\"\".key·5 any) (@\"\".val·1 *any)\n" +
	"func @\"\".cmapaccess2_interlocked (@\"\".mapType·3 *byte, @\"\".info·4 *any, @\"\".hmap·5 map[any]any, @\"\".key·6 *any) (@\"\".val·1 *any, @\"\".pres·2 bool)\n" +
	"func @\"\".cmapaccess2_fast32_interlocked (@\"\".mapType·3 *byte, @\"\".info·4 *any, @\"\".hmap·5 map[any]any, @\"\".key·6 any) (@\"\".val·1 *any, @\"\".pres·2 bool)\n" +
	"func @\"\".cmapaccess2_fast64_interlocked (@\"\".mapType·3 *byte, @\"\".info·4 *any, @\"\".hmap·5 map[any]any, @\"\".key·6 any) (@\"\".val·1 *any, @\"\".pres·2 bool)\n" +
	"func @\"\".cmapaccess2_faststr_interlocked (@\"\".mapType·3 *byte, @\"\".info·4 *any, @\"\".hmap·5 map[any]any, @\"\".key·6 any) (@\"\".val·1 *any, @\"\".pres·2 bool)\n" +
	"func @\"\".cmapassign_interlocked (@\"\".mapType·1 *byte, @\"\".info·2 *any, @\"\".hmap·3 map[any]any, @\"\".key·4 *any, @\"\".val·5 *any)\n" +
	"func @\"\".cmapdelete_interlocked (@\"\".mapType·1 *byte, @\"\".info·2 *any, @\"\".hmap·3 map[any]any, @\"\".key·4 *any)\n" +
	"func @\"\".maprelease_interlocked (@\"\".mapType·1 *byte, @\"\".info·2 *any, @\"\".hmap·3 map[any]any)\n" +
	"func @\"\".cmapiterinfo (@\"\".hiter·2 *any) (? *any)\n" +
